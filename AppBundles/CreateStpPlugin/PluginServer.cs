...
{
    [Guid("506ce94e-88ba-4891-b989-d4cf85ba0ffe")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": CreateStpPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");

            // Initialize AddIn members.
            _inventorServer = addInSiteObject.InventorServer;
            Automation = new CreateStpAutomation(_inventorServer);
        }

        public void Deactivate()
        {
            Trace.TraceInformation(": CreateStpPlugin: deactivating... ");
